...
//            this.callParent([config]);
    ...
    Ext.define('App.BookMasterDetail', {
        ...
        initEvents: function() {
            ...
            //1 notice we use the selectionmodel's rowselect event rather
...
//            bookGridSm.on('selectionchange', this.onRowSelect, this);
            bookGridSm.addListener('selectionchange', this.onRowSelect, this);
        },
...
//    Ext.data.StoreManager.get('gridBookStore').load();
    Ext.getStore('gridBookStore').load();
});
